<%response.cookies("ikmenu") = "ik45.asp"%>
<!-- '#INCLUDE FILE="ik.asp" -->
...
<title>Penyelenggaraan Jenis Ternakan</title>
...
<td width="100%"> 
<form name="form" method ="Post" action="ik45.asp">
<% 
	...
	response.cookies("amenu") = "ik45.asp"
	...
	vrowid = request.form("rowid")
		...
		if vrowid = "" then			
			if vkod <> "" then
				...
				d = " select kod from hasil.jenis_ternakan where kod = '"&vkod&"' "
				...
				Set objRsd = objConn.Execute(d)	
					if not objRsd.eof then
						...
						a1 = " insert into hasil.jenis_ternakan(kod,keterangan) values ('"&vkod&"','"&vketer&"') "
		...
		b1 = " update hasil.jenis_ternakan "
		b1 = b1 & " set kod = '"&vkod&"', "
	...
	if bilrec <> "" then
     for i = 1 to bilrec
         ...
         if b1 = "-" then
            ...
            db = " delete hasil.jenis_ternakan where rowid = '"& rowid &"' "
 ...
 '*****************************************************************************************************
	...
	b = " select rowid, kod, initcap(keterangan) keterangan from hasil.jenis_ternakan order by kod"
...
<td width="52%" bgcolor="#FFFFFF" align="center">
<font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Keterangan</b></font></td>
<td width="15%" bgcolor="#FFFFFF" align="center"></td>
</tr>
<%	if proses1 <> "" then		%>
<tr> 
<td width="8%" bgcolor="#FFFFFF" align="center"><input type="text" name="fkod" size="6" value="<%=fkod%>" maxlength="3" onFocus="nextfield='fketer';"></td>
<td width="52%" bgcolor="#FFFFFF" align="center"><input type="text" name="fketer" size="117" value="<%=fketer%>" maxlength="65" onFocus="nextfield='B1';"></td>
...
<%		else	%>
<tr>  
<td width="8%" bgcolor="#FFFFFF" align="center"><input type="text" name="fkod" size="6" maxlength="3" onFocus="nextfield='fketer';" ></td>
<td width="52%" bgcolor="#FFFFFF" align="center"><input type="text" name="fketer" size="117" maxlength="65" onFocus="nextfield='B1';" ></td>
<td width="15%" bgcolor="#FFFFFF" align="center">
<input type="submit" value="+" name="B1" onFocus="nextfield='done';"><input type="submit" value="res" name="B2">
</td>
</tr>
...
<input type="hidden" name="keter<%=bil%>" value="<%=objRs2("keterangan")%>" ></font>
</td>
</tr>
<%	objRs2.movenext
	loop					%>
