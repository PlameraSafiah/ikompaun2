...
<td width="9%" class="hd1" align="right">Tarikh Bayar</td>
...
'    ff = ff & " from hasil.bil2 where no_akaun = '"& no &"' and status is null "
  ...
  <td width="2%" align="center"><%=objRs2("no_resit")%></td><% end if %> 
<%'----------------------------------------------%>
...
<%	iRecordsShown = iRecordsShown + 1
	...
	total_amaun_bayart = amaun_bayart + total_besaq
%> 
 <tr>
 <td colspan="6" align="right"><b>Jumlah</b></td>
 <td align="right"><b><%=FormatNumber(total_besaq,2)%></b></td></tr>
  <tr>
 <td colspan="6" align="right"><b>Jumlah Keseluruhan</b></td>
 <td align="right"><b><%=FormatNumber(total_amaun_bayart,2)%></b></td></tr>
