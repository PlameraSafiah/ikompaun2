...
Response.AddHeader "content-disposition", "inline; filename=LAPORAN KOMPAUN BELUM JELAS.xls"
%>

<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>i-Kompaun : Laporan Kompaun Belum Jelas (No.Pendaftaran Syarikat)</title>
</head>
...
%>
<br>
<table width="80%" cellspacing="0" cellpadding="1" border="0" frame="box" rules="all" align="center" style="font-family: Calibri; font-size: 11pt;">
    <tr align="center"> 
    <td width="10%" class="hd1" colspan="3"><B>TAJUK : <u>LAPORAN KOMPAUN BELUM JELAS MENGIKUT NO PENDAFTARAN SYARIKAT</u> </B></td>
...
<td width="40%" class="hd1" align="left">No. Pendaftaran Syarikat </td>
</tr>
<%		
