...
tkh1a = cstr(mid(tkh1,1,2)) + "/" + cstr(mid(tkh1,3,2)) + "/" + cstr(mid(tkh1,5,4))
  tkh2a = cstr(mid(tkh2,1,2)) + "/" + cstr(mid(tkh2,3,2)) + "/" + cstr(mid(tkh2,5,4))
	...
	namas = objRss("nama")
		...
		e = " select kod,keterangan from majlis.jabatan where kod = '"& jab &"' "
...
<tr>
    <td width="100%" align="center"><font face="MS Serif" size="3"><b>LAPORAN 
      KOMPAUN MENGIKUT JABATAN</b></font></td>
</tr></table>
...
<table width="85%" align="center" border="0">
  ...
  <tr> 
    <td nowrap><font size="2" face="Verdana"><b> Jabatan</b></font></td>
    <td ><strong><font size="2" face="Arial">:</font></strong></td>
    <td ><font size="2" face="Verdana"><%=jab%>-<%=objJab("keterangan")%></font></td>
  </tr>
</table>
<hr>
<%	end sub	%>
