...
elseif lokasi = "107" then
	...
	jabatan1 = Request.QueryString("fjabatan")
...
<script>
	document.myform.fjabatan.focus();
</script>
...
<%		bil = 0
		...
		e = " select kod,keterangan from majlis.jabatan where kod = '"& fjabatan &"' "
...
<form method="post" action="ik211r.asp"> 
 <table width="50%" cellpadding="1" cellspacing="5" class="hd1">
    <tr>
...
<input type="hidden" name="fjabatan" value="<%=fjabatan%>">
