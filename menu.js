...
function menuItemNormal(el) {
	el.style.background = "1 solid buttonface";
	el.style.color = "";
}
...
function raiseButton(el) {
	...
	//el.style.background = "#00a5d6";//tambahan
	el.style.background = "1 solid buttonface";//tambahan
}

function normalButton(el) {
	//el.style.background = "#00a5d6";//tambahan
	el.style.color = "";//tambahan
...
function pressedButton(el) {
	//el.style.background = "#0A246A";//tambahan
	//el.style.color = "highlighttext";//tambahan
...
function showWindowedObjects(show) {
	if (hideWindowedControls) {
		var windowedObjectTags = new Array("SELECT","INPUT","IFRAME", "OBJECT", "APPLET","EMBED");
